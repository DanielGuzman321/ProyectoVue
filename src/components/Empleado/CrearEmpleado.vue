          ...
          <div class="card-body">
              <form v-on:submit.prevent="formulario">
                      ...
                      <div class="col">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="nombre" aria-describedby="helpId" id="nombre"
                                  placeholder="Ingrese Nombre" v-model="Empleados.nombre" />
                      ...
                      <div class="col">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="apellidos" id="apellidos"
                                  aria-describedby="helpId" placeholder="Ingrese Apellidos" v-model="Empleados.apellidos" />
                      ...
                      <div class="col">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="direccion" id="direccion"
                                  aria-describedby="helpId" placeholder="Ingrese su dirección" v-model="Empleados.direccion" />
                          </div>
                      </div>
                      <div class="col">
                          ...
                          <div class="form-group">
                              ...
                              <input type="ciudad" class="form-control" name="ciudad" id="ciudad" aria-describedby="helpId"
                                  placeholder="Ingrese su ciudad" v-model="Empleados.ciudad" />
                          </div>
                      </div>
                      <div class="col">
                  ...
                  <div class="row">
                      ...
                      <router-link :to="{ name: 'listarempleado' }" class="btn btn-outline-primary" id="finaliza" style="display: none;">Finalizar</router-link>
                  </div>
                  <br>
                  <div class="row">
...
export default {
  ...
  methods: {
      formulario() {
          ...
          axios.post('https://localhost:7294/Empleado', cuerpo).then((result) => {
