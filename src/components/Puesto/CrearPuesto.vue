...
<div class="w3-padding-large" id="main">
    <div class="container">
      <div class="card">
        <div class="card-header" style="font-weight: bold; color: white;">Agregar puesto</div>
        <div class="card-body">
  ...
  export default {
    ...
    methods: {
      agregarRegistro() {
        ...
        axios.post("https://localhost:7294/Puesto", cuerpo).then((result) => {
